exports.emailAlert = (username, message, title) => {
    return `<!DOCTYPE html>
...
exports.arEmailAlert = (username, message, title) => {
    return `<!DOCTYPE html>
    <html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
        xmlns:o="urn:schemas-microsoft-com:office:office">
        ...
        <center style="width: 100%; background-color: #f1f1f1;">
            ...
            <div style="max-width: 600px; margin: 0 auto;" class="email-container">
                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                    ...
                    <tr>
                        <td valign="middle" class="hero bg_white" style="padding: 3em 0 2em 0;">
                            <h1 style="text-align: center;margin-bottom:0px; font-weight: 600; color:rgb(207, 101, 181);font-size: 35px;">مصون</h1>
                                <h3 style="text-align: center;">تحكم أفضل في ميزانيتك</h3>
                        </td>
                                    ...
                                    <td>
                                        <div class="text" style="padding: 0 2.5em; text-align: center;">
                                            ...
                                            <div class="mt-5" style="text-align: right">
                                                <b>
                                                    <div class="mt-3" class="text-dark">
                                                       عزيزي ${username} ، ${message}
                                                    </div>
                                                    <br>
                                                    <br>
                                                    <div class="mt-3" >
                                                       إذا لم تتعرف على هذا البريد الإلكتروني أو تتوقعه ، فيمكنك دائمًا الإبلاغ عن السلوك المشبوه لفريق دعم فريقنا.
                                                    </div>
                                                    <div class="mt-4" class="text-dark">
                                                        <h3>
                                                           فريق مصون
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="text-align: right; padding-right: 10px;">
                                                    <h3 class="heading">حول</h3>
                                                    <p>مصون هو مخطط ميزانية عبر الإنترنت يتولى مسؤولية أموالك. متعقب مجاني للميزانية يساعدك على فهم إنفاقك من أجل مستقبل مالي أكثر إشراقًا.</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="text-align: right; padding-left: 5px; padding-right: 5px;">
                                                    <h3 class="heading">معلومات الاتصال</h3>
                                                    <ul>
                                                        <li><span class="text">
                                                        تطبيق Masoon
                                                            </span></li>
                                                            <li><span class="text">
                                                            عناية: الوكيل المعين HQ-Electro
                                                            </span></li>
                                                            <li><span class="text">
                                                            طريق انس بن مالك ، الياسمين
                                                            </span></li>
                                                            <li><span class="text">
                                                            الرياض 13326
                                                            </span></li>
                                                        <li><span class="text">بريد الالكتروني: info@HQ-electro.com</span></a></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                        </table>
